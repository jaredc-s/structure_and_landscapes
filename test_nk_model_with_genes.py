...
from nk_model_with_genes import NKWithGenes
...
class TestModule(TC):
    def setUp(self):
        self.depend = nk_model_with_genes.generate_dependencies(2, 2, 3, 3)
        self.list_of_strings = [Bitstring("010"), Bitstring("100"),
                           Bitstring("001")]

    def test_dependencies(self):
        long_depend = nk_model_with_genes.generate_dependencies(2, 4, 3, 3)
    ...
    def test_passed_depend(self):
        ...
        subs = nk_model_with_genes.generate_sub_bitstring(self.list_of_strings,
                                                          dependencies, 2)
        self.assertEqual(subs[0][1], Bitstring("10000"))

    def test_sub_bitstring(self):

        full = nk_model_with_genes.generate_sub_bitstring(self.list_of_strings,
                                                           self.depend, 2)
    ...
    def test_linear_jump(self):
        linear_model = nk_model_with_genes.generate_linear_bistring(
